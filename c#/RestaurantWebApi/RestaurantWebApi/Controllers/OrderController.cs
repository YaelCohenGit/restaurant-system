...
namespace RestaurantWebApi.Controllers
{
  ...
  public class OrderController : ControllerBase
  {
    ...
    public FileStreamResult pdf(int orderCode)
    {
      ...
      PdfGridLayoutResult gridResult = pdfGrid.Draw(page, new RectangleF(new PointF(0, 100),
      ...
      int n = Convert.ToInt32(price);
      string s = n + ".00";
      graphics.DrawString("Total price: " + s, priceFont, PdfBrushes.Black, new PointF(380, data.Count * 16 + 135));
      ...
      graphics.DrawString("\n\nThank you for visiting our restaurant.\n\n We will be happy to serve you again!",
        font, PdfBrushes.Black, new PointF(160, data.Count * 10 + 230));
