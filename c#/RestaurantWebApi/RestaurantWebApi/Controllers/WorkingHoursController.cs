...
namespace RestaurantWebApi.Controllers
{
  ...
  public class WorkingHoursController : ControllerBase
  {
    ...
    [EnableCors("CorsPolicy")]
    public void UpdateExitTimeAndTotalHours([FromBody] int workingHoursCode)
    {
      workingHoursService.UpdateExitTimeAndTotalHours(workingHoursCode);
    }
    [HttpGet("employeeDidntExitSystemLastTime/{employeeCode}")]
    [EnableCors("CorsPolicy")]
    public bool EmployeeDidntExitSystemLastTime(int employeeCode)
    {
      return workingHoursService.EmployeeDidntExitSystemLastTime(employeeCode);
    }
  }
}
