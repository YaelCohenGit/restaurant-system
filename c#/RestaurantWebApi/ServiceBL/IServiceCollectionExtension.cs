...
namespace ServiceBL
{
  public static class IServiceCollectionExtension
  {
    public static IServiceCollection AddDependencies(this IServiceCollection collection)
    {
      ...
      options.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\PC\Documents\רות\final-project\c#\RestaurantWebApi\DATA\Restaurant.mdf;Integrated Security=True;Connect Timeout=30"));
      return collection;
    }
  }
}
