...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\PC\\Documents\\רות\\ו' סמינר\\RestaurantWebApi\\DATA\\Restaurant.mdf;Integrated Security=True;Connect Timeout=30");
      }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<Employment>(entity =>
      {
        ...
        entity.Property(e => e.EmploymentName).HasMaxLength(30);
      });
      ...
      modelBuilder.Entity<MealCategory>(entity =>
      {
        ...
        entity.Property(e => e.MealCategoryName).HasMaxLength(30);
      });
      ...
      modelBuilder.Entity<MealIngredientsDetails>(entity =>
      {
        ...
        entity.Property(e => e.MealIngredientsDescription).HasMaxLength(50);
      ...
      modelBuilder.Entity<MealStyle>(entity =>
      {
        ...
        entity.Property(e => e.MealStyleDescription).HasMaxLength(30);
      });
      ...
      modelBuilder.Entity<MealTime>(entity =>
      {
        ...
        entity.Property(e => e.MealTimeDescription).HasMaxLength(30);
      });
      ...
      modelBuilder.Entity<OrderDetails>(entity =>
      {
        ...
        entity.Property(e => e.IsMealCreated).HasDefaultValue(false);

        entity.Property(e => e.HowMuchMealCreated).HasDefaultValue(0);
      ...
      modelBuilder.Entity<WorkingHours>(entity =>
      {
        ...
        entity.Property(e => e.EnterTime).HasMaxLength(30);

        entity.Property(e => e.ExitTime).HasMaxLength(30);

        entity.Property(e => e.TotalHoursForDay).HasMaxLength(30);

        entity.HasOne(d => d.EmployeeCodeNavigation)
                 .WithMany(p => p.WorkingHours)
                 .HasForeignKey(d => d.EmployeeCode)
                 .HasConstraintName("FK__WorkingHours__Employees");
      });
    }
  }
}
