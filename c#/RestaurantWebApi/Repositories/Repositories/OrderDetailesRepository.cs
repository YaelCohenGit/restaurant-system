...
namespace Repositories.Repositories
{
    public class OrderDetailesRepository : IOrderDetailesRepository
    {
        ...
        {
            var isExist = context.OrderDetails.Any(o => o.MealCode == orderDetails.MealCode
            && o.OrderCode == orderDetails.OrderCode && o.IsMealCreated == false);
            if (isExist == true)
            {
        ...
        public List<OrderDetailsReceipt> GetOrderDetailsReceiptsByOrderCode(int orderCode)
        {
            ...
            foreach (var item in orderDetails)
            {
                ...
                if (meal != null)
                {
                    ...
                    int n = Convert.ToInt32(meal.MealPrice);
                    receipt.Price += n + ".00";
        ...
        //public int GetSoldMealAmount()
        //{
        //    int soldMealsAmount = 0;
        //    foreach (var item in context.Orders)
        //    {
        //        if (item.OrderTime.GetValueOrDefault().ToString("dd-MM-yyyy") == DateTime.Today.ToString("dd-MM-yyyy"))
        //        {
        //            foreach (var meal in context.OrderDetails)
        //            {
        //                if (meal.OrderCode == item.OrderCode)
        //                {
        //                    soldMealsAmount += int.Parse(meal.ServingAmount);
        //                }
        //            }
        //        }
        //    }
        //    return soldMealsAmount;
        //}
