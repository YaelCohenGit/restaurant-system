...
export class OnlineMapComponent implements OnInit {
  ...
  hover(table: RestaurantTable) {
    const background = table.tableStatusCode === 500 ? 'rgb(60,200,60)' :
      table.tableStatusCode === 501 ? 'rgb(224, 96, 64)' :
        table.tableStatusCode === 502 ? 'rgb(253, 231, 104)' : 'rgb(5, 159, 211)'; //  'rgb(221, 193, 35)' :'rgb(56, 141, 170)';
    document.getElementById('table' + table.restaurantTableCode).style.backgroundColor = background;
  }
  ...
  ngOnInit() : void {
    ...
    (localStorage.getItem('globalRole').toUpperCase() === "WAITER" ||
